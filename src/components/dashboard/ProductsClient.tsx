          ...
          <div className="overflow-hidden rounded-xl border border-hairline bg-white">
            <table className="w-full text-sm">
              <thead className="border-b border-hairline bg-surface-raised">
                <tr>
                  <th className="px-4 py-3 text-left font-medium text-ink-muted">Product</th>
                  <th className="px-4 py-3 text-left font-medium text-ink-muted">Category</th>
                  <th className="px-4 py-3 text-left font-medium text-ink-muted">Variants</th>
                    ...
                    <td className="px-4 py-3">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          {p.externalId && (
                            <p className="text-xs text-ink-subtle">ID: {p.externalId}</p>
                          )}
                        </div>
                      </div>
                    </td>
